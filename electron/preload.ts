...
contextBridge.exposeInMainWorld('sc', {
  ...
  genreTracks: (term: string) => ipcRenderer.invoke(IPC.SC_GENRE_TRACKS, term),
  ...
  likedTrackIds: () => ipcRenderer.invoke(IPC.SC_LIKED_TRACK_IDS),
  repostedTrackIds: () => ipcRenderer.invoke(IPC.SC_REPOSTED_TRACK_IDS),
